...
export default function Custom404() {
  ...
  return (
    <div className="relative min-h-screen bg-cover bg-center bg-no-repeat flex items-center justify-center bg-background">
      <div className="absolute top-5 right-5 z-20 flex gap-4">
        <Button
          onClick={toggleDark}
          className="p-2 h-[50px] w-[50px] rounded-full bg-surface"
        >
          {isDark ? (
        ...
        <Button
          ...
          className="p-2 rounded-full h-[50px] w-[50px] bg-surface font-medium"
        >
          {t.langSwitch}
        </Button>
      </div>
      ...
      <div className="relative z-10 text-center text-black dark:text-white max-w-xl p-8 rounded-2xl flex flex-col items-center gap-4 animate-fadeIn">
        <div className="rounded-[100px] h-[70px] w-[80px] flex flex-col items-center">
          <svg
            className="my-auto fill-text transition-colors duration-300"
            width="142"
            height="48"
            viewBox="0 0 71 24"
