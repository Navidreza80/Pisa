    ...
    return (
        <div dir='rtl' className='px-[104] pt-[52px]'>
            <div className='flex justify-between w-full'>
                <div className='w-[39.06731%] flex flex-col flex-wrap'>
                    <h1 className='text-[32px] font-bold'>تور گردشگری سالار دره</h1>
                    <div className="flex gap-2 mt-2 mb-[60px] items-center">
                        <MapSVG color="#595959" />
                ...
                <div className='w-[58.1751%]'>
                    <Image
                        className='w-full h-[400px] mt-[140px] rounded-2xl border-[1px] border-[#595959]'
                        width={632}
                        height={400}
                        ...
                        <div className="relative">
                            ...
                            <div className="p-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    <div className="border border-gray-100 p-5 rounded-xl hover:border-gray-200 transition-colors duration-300">
                                        ...
                                        <div className="flex items-end mb-3">
                                            ...
                                            <p className="text-gray-600 mr-2">تومان</p>
                                        </div>
                                    ...
                                    <div className="border border-gray-100 p-5 rounded-xl hover:border-gray-200 transition-colors duration-300">
                                        ...
                                        <ul className="space-y-2">
                                            <li className="flex gap-2 items-center">
                                                <div className="w-1.5 h-1.5 rounded-full bg-blue-600 mr-3 flex-shrink-0"></div>
                                ...
                                <div className="mt-5 border border-gray-100 p-5 rounded-xl hover:border-gray-200 transition-colors duration-300">
                                    ...
                                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                                        <div className="flex flex-col items-center justify-center bg-gray-50 p-3 rounded-lg">
                                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-blue-600 mb-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <div className="mt-5 text-center">
                                    <div className="inline-flex items-center px-4 py-2 bg-gray-50 text-gray-700 text-sm rounded-lg border border-gray-100">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-blue-600 mr-2.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                        </svg>
