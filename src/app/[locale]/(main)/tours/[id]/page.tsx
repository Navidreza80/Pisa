                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="border border-border rounded-xl p-4 sm:p-5">
                                        <div className="flex items-center mb-3">
                                            ...
                                            <h4 className="text-lg font-bold text-text">روز اول: ورود به استانبول</h4>
                                        </div>
                                        <div className="space-y-3 mr-12 border-r border-dashed border-border pr-5">
                                            <div className="relative">
                                                ...
                                                <div className="flex items-center">
                                                    ...
                                                    <span className="text-sm text-shadow-text-secondary">08:00</span>
                                                    <span className="mx-2 text-shadow-text-secondary">-</span>
                                                    <p className="text-text">ورود به فرودگاه استانبول و انتقال به هتل</p>
                                                </div>
                                            </div>
                                            <div className="relative">
                                                <div className="absolute right-[-29px] top-1 w-4 h-4 rounded-full bg-blue-600 dark:bg-blue-500"></div>
                                                <div className="flex items-center">
                                                    <Clock className="w-4 h-4 text-shadow-text-secondary ml-2" />
                                                    <span className="text-sm text-shadow-text-secondary">12:00</span>
                                                    <span className="mx-2 text-shadow-text-secondary">-</span>
                                                    <p className="text-text">استراحت و صرف ناهار در رستوران سنتی</p>
                                                </div>
                                            </div>
                                            <div className="relative">
                                                <div className="absolute right-[-29px] top-1 w-4 h-4 rounded-full bg-blue-600 dark:bg-blue-500"></div>
                                                <div className="flex items-center">
                                                    <Clock className="w-4 h-4 text-shadow-text-secondary ml-2" />
                                                    <span className="text-sm text-shadow-text-secondary">16:00</span>
                                                    <span className="mx-2 text-shadow-text-secondary">-</span>
                                                    <p className="text-text">بازدید از میدان تقسیم و خیابان استقلال</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="border border-border rounded-xl p-4 sm:p-5">
                                        <div className="flex items-center mb-3">
                                            ...
                                            <h4 className="text-lg font-bold text-text">روز دوم: بازدید از آثار تاریخی</h4>
                                        </div>
                                        <div className="space-y-3 mr-12 border-r border-dashed border-border pr-5">
                                            <div className="relative">
                                                <div className="absolute right-[-29px] top-1 w-4 h-4 rounded-full bg-blue-600 dark:bg-blue-500"></div>
                                                <div className="flex items-center">
                                                    <Clock className="w-4 h-4 text-shadow-text-secondary ml-2" />
                                                    <span className="text-sm text-shadow-text-secondary">09:00</span>
                                                    <span className="mx-2 text-shadow-text-secondary">-</span>
                                                    <p className="text-text">بازدید از مسجد آبی و ایاصوفیه</p>
                                                </div>
                                            </div>
                                            <div className="relative">
                                                <div className="absolute right-[-29px] top-1 w-4 h-4 rounded-full bg-blue-600 dark:bg-blue-500"></div>
                                                <div className="flex items-center">
                                                    <Clock className="w-4 h-4 text-shadow-text-secondary ml-2" />
                                                    <span className="text-sm text-shadow-text-secondary">13:00</span>
                                                    <span className="mx-2 text-shadow-text-secondary">-</span>
                                                    <p className="text-text">صرف ناهار در رستوران با منظره بسفر</p>
                                                </div>
                                            </div>
                                            <div className="relative">
                                                <div className="absolute right-[-29px] top-1 w-4 h-4 rounded-full bg-blue-600 dark:bg-blue-500"></div>
                                                <div className="flex items-center">
                                                    <Clock className="w-4 h-4 text-shadow-text-secondary  ml-2" />
                                                    <span className="text-sm text-shadow-text-secondary">15:00</span>
                                                    <span className="mx-2 text-shadow-text-secondary">-</span>
                                    ...
                                    <div className="relative">
                                        <div className="pt-6 pb-4 px-6 border-b border-border">
                                            <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
                                                <div>
                                                    <span className="inline-block px-3 py-1 rounded-md text-blue-600 dark:text-blue-300 text-sm font-medium mb-2">تور ویژه تابستانه</span>
                                                    <h2 className="text-xl sm:text-2xl font-bold text-shadow-text mb-1">مزایای اختصاصی تور استانبول</h2>
                                                    <p className="text-shadow-text-secondary text-sm">تجربه‌ای منحصر به فرد در قلب ترکیه</p>
                                                </div>
                                        ...
                                        <div className="p-4 sm:p-6">
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5">
                                                <div className="border border-border p-4 sm:p-5 rounded-xl  transition-colors duration-300 bg-surface">
                                                    <div className="flex items-center mb-3">
                                                        ...
                                                        <h3 className="text-lg font-bold text-text">هزینه تور</h3>
                                                    </div>
                                                    <p className="text-text text-sm mb-2">شروع قیمت از:</p>
                                                ...
                                                <div className="border border-border p-4 sm:p-5 rounded-xl transition-colors duration-300 bg-surface">
                                                    <div className="flex items-center mb-3">
                                                        ...
                                                        <h3 className="text-lg font-bold text-text">زمانبندی تور</h3>
                                                    </div>
                                                    <div className="grid grid-cols-2 gap-3 mb-3">
                                                        <div className="bg-background p-2 rounded-lg">
                                                            <p className="text-text text-xs mb-1">تاریخ شروع:</p>
                                                            <p className="font-bold text-shadow-text-secondary text-sm">11 تیر 1400</p>
                                                        </div>
                                                        <div className="bg-background p-2 rounded-lg">
                                                            <p className="text-text text-xs mb-1">تاریخ پایان:</p>
                                                            <p className="font-bold text-shadow-text-secondary text-sm">15 تیر 1400</p>
                                                        </div>
                                                    </div>
                                                    <div className="flex items-center">
                                                        ...
                                                        <p className="text-text-secondary text-sm">مدت زمان: <span className="font-bold text-blue-600 dark:text-blue-400">5 روز</span></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5 mt-4 sm:mt-5">
                                                <div className="border border-border p-4 sm:p-5 rounded-xl transition-colors duration-300 bg-surface">
                                                    <div className="flex items-center mb-3">
                                                        ...
                                                        <h3 className="text-lg font-bold text-text">خدمات شامل</h3>
                                                    </div>
                                                ...
                                                <div className="border border-border p-4 sm:p-5 rounded-xl transition-colors duration-300 bg-surface">
                                                    <div className="flex items-center mb-3">
                                                        ...
                                                        <h3 className="text-lg font-bold text-text">امکانات ویژه</h3>
                                                    </div>
                                                    <ul className="space-y-2">
                                                        <li className="flex gap-2 items-center">
                                                            <div className="w-1.5 h-1.5 rounded-full bg-blue-600 dark:bg-blue-400 mr-3 flex-shrink-0"></div>
                                                            <span className="text-text-secondary text-sm">بیمه مسافرتی با پوشش کامل</span>
                                                        </li>
                                                        <li className="flex gap-2 items-center">
                                                            <div className="w-1.5 h-1.5 rounded-full bg-blue-600 dark:bg-blue-400 mr-3 flex-shrink-0"></div>
                                                            <span className="text-text-secondary text-sm">اقامت در هتل 4 ستاره با خدمات عالی</span>
                                                        </li>
                                                        <li className="flex gap-2 items-center">
                                                            <div className="w-1.5 h-1.5 rounded-full bg-blue-600 dark:bg-blue-400 mr-3 flex-shrink-0"></div>
                                                            <span className="text-text-secondary text-sm">دسترسی به اینترنت پرسرعت رایگان</span>
                                                        </li>
                                                        <li className="flex gap-2 items-center">
                                                            <div className="w-1.5 h-1.5 rounded-full bg-blue-600 dark:bg-blue-400 mr-3 flex-shrink-0"></div>
                                                            <span className="text-text-secondary text-sm">هدیه ویژه به همراه سوغاتی</span>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div className="mt-4 sm:mt-5 border border-border p-4 sm:p-5 rounded-xl transition-colors duration-300 bg-surface">
                                                <div className="flex items-center mb-3">
                                                    ...
                                                    <h3 className="text-lg font-bold text-text">ویژگی‌های برجسته</h3>
                                                </div>
                                                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                                                    <div className="flex flex-col items-center justify-center p-3 rounded-lg">
                                                        ...
                                                        <span className="text-xs text-text-secondary text-center">اقامت لوکس</span>
                                                    </div>
                                                    <div className="flex flex-col items-center justify-center p-3 rounded-lg">
                                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-blue-600 dark:text-blue-400 mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                                        </svg>
                                                        <span className="text-xs text-text-secondary text-center">قیمت مناسب</span>
                                                    </div>
                                                    <div className="flex flex-col items-center justify-center -700 p-3 rounded-lg">
                                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-blue-600 dark:text-blue-400 mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                                                        </svg>
                                                        <span className="text-xs text-text-secondary text-center">راهنمای مجرب</span>
                                                    </div>
                                                    <div className="flex flex-col items-center justify-center  p-3 rounded-lg">
                                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-blue-600 dark:text-blue-400 mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                                                        </svg>
                                                        <span className="text-xs text-text-secondary text-center">امنیت کامل</span>
                                                    </div>
                                                </div>
                                            </div>
