...
import Quality from '@/components/common/svg/about-us/quality';
import Innovation from '@/components/common/svg/about-us/innovation';
import Collaboration from '@/components/common/svg/about-us/collaboration';
import Phone from '@/components/common/svg/about-us/Phone';
import Email from '@/components/common/svg/about-us/email';
import Address from '@/components/common/svg/about-us/address';
        ...
        <main className="min-h-screen py-[20px] px-4 dark:bg-gray-900">
            <div className="container mx-auto">
                ...
                <div className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                    <Features title={t('quality')} desc={t('qualityDesc')} icon={<Quality />} />

                    <Features title={t('innovation')} desc={t('innovationDesc')} icon={<Innovation />} />

                    <Features title={t('collaboration')} desc={t('collaborationDesc')} icon={<Collaboration />} />
                </div>
