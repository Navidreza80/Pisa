...
export default function AboutUs() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      const marker = L.marker([36.597443366463594, 53.06466700125748], {
        icon: customIcon,
      }).addTo(map);
            ...
            <div>
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  ...
                  <a
                    href="#"
                    className="w-10 h-10 bg-blue-800 rounded-full flex items-center justify-center text-white hover:bg-blue-900 transition"
                  >
                    <svg
                      className="w-5 h-5"
                      fill="currentColor"
        ...
        <div className="mt-24 max-w-6xl mx-auto">
          ...
          <div className="bg-white dark:bg-gray-800 p-4 rounded-xl shadow-lg">
            <div className="h-96 bg-gray-200 dark:bg-gray-700 rounded-lg">
              <div
                id="map"
                className="w-full h-full rounded-lg dark:border dark:border-gray-700"
              ></div>
            </div>
          </div>
        </div>
