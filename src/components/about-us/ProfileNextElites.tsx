    ...
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden transform transition-all hover:scale-105">
        ...
        <div className="relative px-6 pb-6">
            ...
            <div className="flex justify-center gap-4 mt-4">
                ...
                <a href={`https://linkedin.com/in/${name}`} target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-blue-600 transition">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
...
export default ProfileNextElites