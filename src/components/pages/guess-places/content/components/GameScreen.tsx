          ...
          <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
            <div className="flex items-center justify-between">
              <Badge className="bg-primary text-white text-sm px-3 py-1 rounded-full">
                {t('questionCounter', { current: currentIndex + 1, total: 15 })}
              </Badge>
          ...
          <TabsContent value="guess" className="mt-0">
            ...
            <div className="flex w-full justify-between mt-4">
              ...
              >
                ...
                <h1 className="text-text font-medium">{t('resetButton')}</h1>
              </Button>
              ...
              >
                ...
                <h1 className="text-text font-medium">{t('statsButton')}</h1>
              </Button>
            </div>
              ...
              >
                {result === "correct" ? (
                  <>
                    ...
                    <p className="font-bold">{t('feedback.correct')}</p>
                  </>
                ) : (
                  <>
                    ...
                    <div>
                      ...
                      {showAnswer && currentPlace && (
                        <p className="text-sm">{t('feedback.correctAnswer', { answer: currentPlace.name })}</p>
                      )}
                    </div>
                  </>
                )}
