export default function BlogCardSkeleton() {
  return (
    <div className="w-[390px] max-[600px]:w-full bg-text-surface border border-border rounded-[40px] p-6 flex flex-col justify-between">
      <div className="flex flex-col gap-4 animate-pulse">
        ...
        <div className="flex justify-between items-center text-xs mt-2">
          <div className="flex items-center gap-2">
            ...
            <div className="h-3 w-25 bg-border rounded-md animate-pulse" />
          </div>
        </div>
