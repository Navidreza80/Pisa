...
const Comments = () => {
    const comments = [
        ...
        {
            id: 3,
            content: "خیلی خیل خیلی خیلی خیلی خیلی خیلی خیلیییییییییییییییییییییی عالی",
            author: "مریم حسینی",
            date: "20 مرداد 2020"
        },
        {
                ...
                {comments.map(comment => (
                    <SwiperSlide key={comment.id}>
                        <div className="bg-[#586CFF] flex flex-col flex-wrap justify-between p-6 rounded-[32px] shadow-md border border-gray-100 h-[426px] w-[385px]">
                            <p className="text-white text-[16px] font-[500] mb-4">{comment.content}</p>
                            <div className="flex justify-end gap-[8px] ">
                                <div className='flex flex-col flex-wrap'>
                                    <span className='text-[16px] font-semibold text-white'>{comment.author}</span>
                                    <span className='text-[14px] font-[500] text-[#E5E5E5]'>{comment.date}</span>
                                </div>
                                <Image width={48} height={48} className='rounded-full' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQflP_6B6B0zYzZqpsQTXbBKAflqqVPvX2nsg&s" alt='profile' />
                            </div>
                        </div>
                    </SwiperSlide>
                ))}
