...
function Register2() {
  ...
  const handlePaste = (e) => {
    ...
    if (paste.length) {
      setCode(
        paste.split("").concat(Array(CODE_LENGTH - paste.length).fill(""))
      );
      setTimeout(() => {
  ...
  return (
    <>
      <div className="w-full flex flex-col gap-[32px]">
        ...
        <div dir="rtl">
          <h1 className="text-[36px] text-right font-[700] text-[#000000] mb-[30px]">
            ثبت نام در پیزا
          </h1>
          <div className="text-[14px] text-right flex gap-[3px] font-[600] text-[#767676]">
            کد تایید ارسال شده به{" "}
            <p className="text-[#586CFF]">Example@gmail.com</p> را وارد کنید.
          </div>
          {editingEmail ? (
            <div className="flex items-center gap-2">
              ...
              />
              <button
                className="text-[#586CFF] underline text-xs"
            ...
            <button
              className="text-[#586CFF] text-[14px] font-[600] underline text-xs"
        ...
        >
          <span className="text-[14px] w-full font-[500] mb-[8px] text-right text-[#222]">
            کد تایید
          </span>
