...
function RightImg({ detail }) {
    ...
    const virtualTours = [
        ...
        { title: "حیاط", url: 'https://static.vecteezy.com/system/resources/previews/028/675/380/large_2x/360-hdri-panorama-view-in-garden-with-flower-bed-yard-near-wooden-eco-house-in-village-in-equirectangular-spherical-projection-for-vr-ar-content-photo.jpg' }
    ];
